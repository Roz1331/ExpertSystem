...
(barParam(param Нет_необходимости_сидеть_после_закрытия))
=>
(assert(barParam(param Обниматься_с_котом__до_закрытия_)))
...
(barParam(param Обниматься_с_котом__до_закрытия_))
=>
(assert(barParam(param Бар_Квадрюпель)))
...
(assert(appendmessagehalt "Бар для привитых представительных персон которым ещё и рано вставать")))
...
=>
(assert(barParam(param Бар_Коррида)))
(assert(appendmessagehalt "Бар для привитых представительных персон, которым ещё и рано вставать => Коррида")))
...
=>
(assert(barParam(param Бар_Красный_Крокодил)))
(assert(appendmessagehalt "Бар для привитых представительных персон, которым ещё и рано вставать => Красный Крокодил")))
